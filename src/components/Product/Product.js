...
const Product = (props) => {
  ...
  const handleColor = (color) => {
    ...
    console.log('handle color działa!: ', currentProduct)
  };
    ...
    const handleSize = (size) => {
      ...
      console.log('handle size działa!: ', currentProduct)
    };

    console.log('this is currentPoduct: ', currentProduct);
    console.log('this is currentColor: ', currentProduct.currentColor);
